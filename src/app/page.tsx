        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { icon: <RefreshCw size={22} style={{ color: 'var(--cyan-400)' }} />, title: 'Spesialis Barang Bekas', desc: 'Mobil, properti, dan barang preloved — semua dengan foto asli langsung dari sumbernya.', badge: 'BEKAS', badgeStyle: { background: 'rgba(34,211,238,0.10)', color: 'var(--cyan-400)', border: '1px solid rgba(34,211,238,0.20)' } },
