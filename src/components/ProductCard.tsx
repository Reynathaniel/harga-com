...
export function ProductCard({ product, compact = false }: Props) {
  ...
  const isValidImg = !imgFailed && rawImg && rawImg.startsWith('http') && !rawImg.includes('placehold.co') && !rawImg.includes('placeholder') && !rawImg.includes('picsum.photos')
