  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[var(--border-subtle)] transition-all duration-300"
      style={{
        ...
        boxShadow: scrolled ? '0 1px 0 rgba(63,63,70,0.8), 0 4px 20px rgba(0,0,0,0.4)' : '0 1px 0 rgba(63,63,70,0.5)',
      }}>
      ...
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5 ml-2">
          <Link href="/cari" className="md:hidden flex items-center justify-center w-9 h-9 text-[var(--text-secondary)] hover:text-white hover:bg-[var(--bg-hover)] rounded-lg transition-colors">
            <Search size={16} />
          </Link>
